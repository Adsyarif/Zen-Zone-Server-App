...
from app.controler.counselor_detail_controller import get_all_counselor_detail, get_counselor_detail_by_id, create_new_counselor_id, update_counselor_detail_by_id, get_counselor_details_id_counselor, update_counselor_details
...
counselor_detail_routes.route("/counselor/<int:account_id>", methods=["GET"])(get_counselor_details_id_counselor)
counselor_detail_routes.route("/counselor/edit/<int:account_id>", methods=["PUT"])(update_counselor_details)
