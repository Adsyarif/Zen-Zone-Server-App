...
from app.controler.list_schedule_controller import get_all_list_schedules, get_schedule_by_counselor_id, post_schedule_by_counselor_id, put_user_booked_by_account_id, put_user_reschedule_by_schedule_id, put_cancel_by_account_id, delete_schedule_by_counselor_id
...
list_schedule.route("/list_schedule/reschedule/<int:account_id>/<int:schedule_id>", methods=["PUT"])(put_user_reschedule_by_schedule_id)
list_schedule.route("/list_schedule/cancel/<int:account_id>/<int:schedule_id>", methods=["PUT"])(put_cancel_by_account_id)
list_schedule.route("/list_schedule/<int:counselor_id>", methods=["DELETE"])(delete_schedule_by_counselor_id)