...
from app.controler.articles_controler import get_all_articles, get_articles_by_article_id, get_articles_by_tag, create_article, delete_article, edit_article
...
articles_routes.route("/articles/<int:article_id>", methods=["PUT"])(edit_article)
