...
class Report_post(Base):
    ...
    user_details = relationship("User_details", back_populates="report_post")
    report_category = relationship("Report_category", back_populates="report_post")
