...
from app.routes.review_counselor_route import review_counselor_routes
...
CORS(app, origins=['https://zen-app-client-app.vercel.app','https://zen-app-client-app-be1q.vercel.app','http://localhost:5000', 'http://localhost:3000'], supports_credentials=True)
...
app.register_blueprint(review_counselor_routes)
